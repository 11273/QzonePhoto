...
相册列表中通过不同图标直观展示相册权限状态：

| 图标 | 权限类型 | 说明 |
|------|----------|------|
| 无 | 所有人可见 | 公开相册 |
| 👤 | QQ好友可见 | 仅QQ好友可查看 |
| ❓ | 回答问题可见 | 需回答设定问题，点击可查看问答 |
| 🔑 | 密码访问 | 需输入密码 |
| 👁️ | 部分好友可见 | 仅指定好友可查看 |
| 🙈 | 部分好友不可见 | 屏蔽指定好友 |
| 🔒 | 仅自己可见 | 私密相册 |
...
对于设置了「回答问题可见」的相册，支持查看问题和答案：

- **侧栏快捷查看**：点击相册旁的 ❓ 图标，弹出气泡显示问题与答案
- **顶栏详情查看**：进入相册后，顶部信息栏点击问题卡片可展开查看答案
- **仅主人可见**：答案仅相册主人可查看，查看好友相册时会提示"仅主人可见"
